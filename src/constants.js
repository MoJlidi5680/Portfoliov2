...
import TypeScriptLogo from "./assets/tech_logo/typescript.svg";
import PhpLogo from "./assets/tech_logo/php.svg";

// AI Skill Logos
import TensorflowLogo from "./assets/tech_logo/tensorflow.svg";
import OpencvLogo from "./assets/tech_logo/opencv.svg";
import ScikitlearnLogo from "./assets/tech_logo/scikitlearn.svg";
import NlpLogo from "./assets/tech_logo/nlp.svg";
...
export const SkillsInfo = [
  ...
  },
  {
    ...
    skills: [
      { name: "Machine Learning", logo: ScikitlearnLogo },
      { name: "Deep Learning", logo: TensorflowLogo },
      { name: "Computer Vision", logo: OpencvLogo },
      { name: "NLP", logo: NlpLogo },
      { name: "RAG", logo: RagLogo },
      { name: "LangChain", logo: LangchainLogo },
      { name: "LLM", logo: LlmLogo },
    ],
  },
  {
    title: "Languages",
